...
def create_mock_request(body: dict = None, headers: dict = None) -> func.HttpRequest:
...
def test_valid_cpf_returns_200():
...
def test_valid_formatted_cpf_returns_200():
...
def test_valid_cpf_no_ip_header_returns_200():
...
def test_repeated_digits_cpf_returns_400():
...
def test_missing_cpf_field_returns_400():
...
def test_rate_limit_exceeded_returns_429(mock_is_rate_limited):
...
def test_generic_exception_returns_500(mock_validate):
